...
float linear_x_speed = 0.3;
float linear_y_speed = 0.3;
float angular_speed = 0.5;

float init_linear_x_speed = 0.3;
float init_linear_y_speed = 0.3;
float init_angular_speed = 0.5;
 ...
 **************************************************************************/
void checkInfraredDistOld(float infrared_f, float infrared_l, float infrared_r,
		       float tolerance, float warn_distance) {
	...
	if (infrared_f > warn_distance) //判断能否直行
	{
		//始终控制小车保持在过道的中间位置
